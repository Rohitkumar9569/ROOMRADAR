                    ...
                    return (
                      ...
                      >
                        ...
                        <div className="flex-1 truncate">
                          ...
                          <div className="opacity-75">{booking.student?.name || 'Room seeker'}</div>
                        </div>
                      </motion.div>
                    );
                  })}
                    ...
                    >
                      <div className="flex items-start justify-between gap-3">
                        <div className="min-w-0">
                          ...
                          <p className="mt-1 truncate text-xs font-semibold text-light-muted dark:text-dark-muted">{booking.student?.name || 'Room seeker'}</p>
                        </div>
