// src/components/LandlordAboutMe.jsx
    ...
    return (
        <div className="bg-slate-50 min-h-screen p-4 md:p-6">
            ...
            <div className="bg-slate-800 text-white rounded-2xl p-8 max-w-lg mx-auto text-center shadow-lg">
                ...
                <p className="text-slate-400 mt-1">Host</p>
            </div>
            ...
            <div className="bg-white border border-neutral-200 rounded-2xl p-6 mt-8 max-w-lg mx-auto flex items-center justify-between shadow-sm">
                <div>
                    <h4 className="font-semibold text-slate-800">Complete your host profile</h4>
                    <p className="text-slate-600 text-sm mt-1">A complete profile builds trust with renters.</p>
                </div>
                <button className="bg-indigo-600 text-white font-semibold py-2 px-4 rounded-lg hover:bg-indigo-700 transition flex items-center gap-2">
...
export default LandlordAboutMe;