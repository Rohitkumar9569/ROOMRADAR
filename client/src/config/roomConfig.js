  ...
  sections: [
    {
      ...
      label: 'Basic Details',
      fields: [
        { key: 'title', label: 'Room Title', type: 'text', required: true, icon: 'home', showOnCard: true, showOnDetail: true, filterable: false },
        ...
        { key: 'description', label: 'Description', type: 'textarea', required: true, showOnCard: false, showOnDetail: true },
    ...
    },
    {
      ...
      label: 'Location',
      fields: [
        { key: 'fullAddress', label: 'Full Address', type: 'text', required: true, showOnCard: true, showOnDetail: true },
        { key: 'locality', label: 'Locality / Area', type: 'text', required: false, showOnCard: true, showOnDetail: true, filterable: true },
        { key: 'landmark', label: 'Nearby Landmark', type: 'text', required: false, showOnCard: false, showOnDetail: true },
        { key: 'city', label: 'City', type: 'text', required: true, showOnCard: true, showOnDetail: true, filterable: true },
        { key: 'state', label: 'State', type: 'text', required: true, showOnCard: false, showOnDetail: true },
        { key: 'pincode', label: 'Pincode', type: 'text', required: true, showOnCard: false, showOnDetail: true },
      ],
    },
    {
      id: 'amenities',
    ...
    },
    {
      ...
      fields: [
        ...
        { key: 'entryTiming', label: 'Entry Timing', type: 'text', showOnCard: false, showOnDetail: true },
        { key: 'visitorTiming', label: 'Visitor Timing', type: 'text', showOnCard: false, showOnDetail: true },
        { key: 'quietHours', label: 'Quiet Hours', type: 'text', showOnCard: false, showOnDetail: true },
    ...
    },
    {
      ...
      label: 'Nearby Access',
      fields: [
        { key: 'distanceCollege', label: 'College / University Distance', type: 'number', required: false, icon: 'graduation-cap', unit: 'km', valueUnit: true, showOnCard: false, showOnDetail: true, filterable: false },
        { key: 'distanceHospital', label: 'Hospital Distance', type: 'number', required: false, icon: 'hospital', unit: 'km', valueUnit: true, showOnCard: false, showOnDetail: true, filterable: false },
        { key: 'distanceMetro', label: 'Metro Distance', type: 'number', required: false, icon: 'train', unit: 'km', valueUnit: true, showOnCard: false, showOnDetail: true, filterable: false },
        { key: 'distanceBusStand', label: 'Bus Stand Distance', type: 'number', required: false, icon: 'bus', unit: 'km', valueUnit: true, showOnCard: false, showOnDetail: true, filterable: false },
        { key: 'distanceRailway', label: 'Railway Station Distance', type: 'number', required: false, icon: 'train-front', unit: 'km', valueUnit: true, showOnCard: false, showOnDetail: true, filterable: false },
        { key: 'distanceMarket', label: 'Market Distance', type: 'number', required: false, icon: 'shopping-bag', unit: 'km', valueUnit: true, showOnCard: false, showOnDetail: true, filterable: false },
      ],
    },
    {
      id: 'guidebook',
      ...
      fields: [
        { key: 'wifiName', label: 'WiFi Name', type: 'text', required: false, icon: 'wifi', showOnCard: false, showOnDetail: false, postBookingOnly: true },
        { key: 'wifiPassword', label: 'WiFi Password', type: 'text', required: false, icon: 'key', showOnCard: false, showOnDetail: false, postBookingOnly: true },
        { key: 'checkInInstructions', label: 'Check-in Instructions', type: 'textarea', required: false, icon: 'door-open', showOnCard: false, showOnDetail: false, postBookingOnly: true },
